...
public class UserController {
    ...
    @RequestMapping(value = "/updateUserInfoPc", method = RequestMethod.POST)
    @Transactional
    public APIResponse updateUserInfoPc(User user) throws IOException {
    ...
    @Transactional
    public APIResponse updateUserInfo( User user,@RequestParam String id) throws IOException {
        User tmpUser =  userService.getUserDetail(id);
        if(tmpUser.getRole().equals(String.valueOf(User.NormalUser))){
            // username和password不能改，故置空
            user.setUsername(null);
            user.setPassword(null);
